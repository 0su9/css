window.addEventListener('DOMContentLoaded', () => {
  // 샘플 영상 ID
  const sampleVideoId = 'rvpa4q54k088n9g1vvs08btdl';

  // 샘플 주소로 입력창 채우기
  urlInput.value = `https://kakaotv.daum.net/embed/player/cliplink/${sampleVideoId}`;
...
function generateTag() {
  ...
  if (!videoId) {
    resultBox.value = '⚠️ 유효한 kakao주소를 입력해주세요.';
    previewFrame.srcdoc = '';
    return;
  }
