...
window.DEFAULT_SETTINGS = {
  css: `body, #primaryContent {
background-image: 
linear-gradient(90deg, #ffffff, #e1fbfc 18%, transparent, transparent),
url('https://t1.daumcdn.net/cafeattach/1ZnML/cef4070f798e91d2a70ba59ab2463c48690c5e62'),
url('https://t1.daumcdn.net/cafeattach/1ZnML/c790a291da8930315952ebc27b4f55d917a1964f'),
url('https://t1.daumcdn.net/cafeattach/1ZnML/119c921425d53aefed92b2d36188744f128bd7ba');
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function generateCSS() {
    ...
    const lines = ['body, #primaryContent {'];
